...
const AnimatedSvgComponent: React.FC<AnimatedSvgComponentProps> = ({
  ...
  // 生成段落文本或链接
  const renderedParagraph = paragraphText ? (
    ...
    >
      <foreignObject height={height} width={width}>
        <div>
          ...
          <a
            className={`animated-svg-card w-full h-full flex flex-col items-center justify-center m-0 rounded-md cursor-pointer ${
